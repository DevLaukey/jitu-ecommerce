...
const ProductEdit = ({ setViewModal, user, productID }) => {
  ...
  useEffect(() => {
    // let rows, total = 0;
    axios
      .get(`${baseURL}/products?page=1&size=3&search=${user}`)
      .then((response) => {
  ...
  const updateUser = () => {
    axios
      .post(`${baseURL}/edit-product`, {proddId,name, imageUrl, price, description, category, email})
      .then((response) => {
              ...
              <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                  ...
                  <input
                    ...
                    type="text"
                    id="grid-fullname"
                    placeholder={userDetails.productName}
                    onChange={(e) => {
                      e.preventDefault();
              ...
              <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-1/2 px-3">
                  ...
                  <input
                    ...
                    placeholder={userDetails.categoryId}
                  />
                </div>
                <div class="w-1/2 px-3">
                  <label
