    ...
    <header className="text-white flex sticky z-50 top-0 left-0 right-0 space-x-4 items-center justify-between align-middle w-full  p-4 bg-blue-400">
      ...
      <div className="flex items-center justify-between gap-x-4">
        ...
        <div
          ...
          className="dropdown flex relative"
        >
          <div className="dropdown flex relative">
            {profileUpdated? (
              <img src={profileUpdated} alt="profile" />
            ) : (
          ...
          >
            ...
            <li className="">
						  <p className="rounded-b  text-white bg-blue-400 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" onClick={() => {
							  showModal(!modal);
			  }}>
