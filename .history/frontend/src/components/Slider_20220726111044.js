  ...
  return (
    <>
      ...
      >
        ...
        <SwiperSlide className="flex items-center justify-center">
          <img
            src="hhttps://images.unsplash.com/photo-1540574163026-643ea20ade25?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MjB8fGZ1cm5pdHVyZXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60"
            alt="brown and black rolling chair"
            className="object-cover w-full h-auto "
          />
        </SwiperSlide>
