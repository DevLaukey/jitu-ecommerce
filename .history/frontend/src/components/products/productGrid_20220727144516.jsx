...
import { nextPageNumber, previousPageNumber } from "../../redux/slices/productReducer";
...
const dispatch = useDispatch()
	...
	useEffect(() => {
		setProducts([]);
		// let rows, total = 0;
		axios.get(`${baseURL}/products?page=${page}&size=${size}&search=${search ? search : ""}`).then((response) => {
