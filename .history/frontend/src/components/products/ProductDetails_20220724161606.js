      ...
      <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          ...
          <div class="flex justify-center mt-4">
            ...
            {cartAdded ? (
              <div className="ml-4 inline-flex items-center text-black-700 bg-blue-200 border-0 py-2 px-6 focus:outline-none hover:bg-gray-300 rounded text-lg space-x-3 -space-x-3" >
                <BsFillFileMinusFill
              ...
              <button
                onClick={addItems}
                class="ml-4 inline-flex items-center text-black-700 bg-blue-200 border-0 py-2 px-6 focus:outline-none hover:bg-gray-300 rounded text-lg"
              >
                <span>
                  <BsCartPlus />
                </span>
