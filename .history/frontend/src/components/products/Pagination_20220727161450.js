    ...
    <div className="flex p-5 space-x-1 justify-center ">
      ...
      {maxPage === page ? (
        <button
          type="button"
          disabled
          className="cursor-not-allowed inline-block px-3 py-1.5 bg-zinc-400 text-white font-medium text-xs uppercase rounded hover:bg-zinc-700 hover:shadow-lg focus:bg-zinc-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-zinc-600 active:shadow-md transition duration-150 ease-in-out"
        >
          Next
        </button>
      ) : (
